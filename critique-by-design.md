...
- I ran into a huge challenge with the data. There was so much data clean-up that needed to be done on the provided spreadsheets that I decided to simply use what he already had and make it clear that it was HIS data set. I also decided to eliminate the "Used by Humans" section because it didn't add to my story. 
