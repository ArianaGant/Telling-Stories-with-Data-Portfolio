...
- The data is both wrong and misleading. More details below.
-It really is quite aesthetic. The colors are pretty, it’s a unique visualization, I like the concept of the layers, and I like how dots are (kind of) proportional to percentage.
...
- The organism and used by humans data are from separate data sets than the higher layers. 
- The organism data set appears to be cobbled together from various sources. 
- I can’t find the used by humans data set. The link doesn't work and I can’t find it online.
...
- McCandless certainly supports the thesis of the book that information is beautiful. However, I think his use of the data itself could be improved upon based on the data inconsistencies. 
...
- I’m thinking of changing the visualization form to an Alluvial Diagram. I hope that changing the format will eliminate some of my original visual confusion. 
